...
<div class="row">
    ...
    <!-- Submit Page -->
    <form id="register-form" method="post" action="<?= site_url() ?>/publicar/store">
        <div class="col-md-12">
            <div class="submit-page">
                ...
                <div class="submit-section">
                    ...
                    <div class="form">
                        ...
                        <input name="TituloPropiedad" class="search-field" type="text" value=""/>
                    </div>
                    ...
                    <div class="row with-forms">
                        ...
                        <div class="col-md-6">
                            <h5>Estado</h5>
                            <select name="Estado" class="chosen-select-no-single" >
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="TipoInmueble" class="chosen-select-no-single" >
                                <option label="blank"></option>     
                    ...
                    <div class="row with-forms">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="select-input disabled-first-option">
                                <input name="Precio" type="text" data-unit="ARS">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <h5>Area</h5>
                            <div class="select-input disabled-first-option">
                                <input name="Area" type="text" data-unit="Mts2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <h5>Ambientes</h5>
                            <select name="Ambientes" class="chosen-select-no-single" >
                                <option label="blank"></option> 
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                ...
                <div class="submit-section">
                    ...
                    <div class="row with-forms">
                        ...
                        <div class="col-md-12">
                            ...
                            <h5>Codigo postal</h5>
                            <input name="CodigoPostal" type="text" value="" id="postal_code">
                ...
                <div class="submit-section">
                    ...
                    <div class="row with-forms">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="EdadInmueble" class="chosen-select-no-single" >
                                <option label="blank"></option> 
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="Cuartos" class="chosen-select-no-single" >
                                <option label="blank"></option> 
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="Banos" class="chosen-select-no-single" >
                                <option label="blank"></option> 
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                    ...
                    <div class="checkboxes in-row margin-bottom-20">
                        ...
                        <input name="checks[]" id="check-2" type="checkbox" value="Aire Acondicionado">
                        <label for="check-2">Aire Acondicionado</label>

                        <input name="checks[]" id="check-3" type="checkbox" value="Piscina">
                        <label for="check-3">Piscina</label>

                        <input name="checks[]" id="check-4" type="checkbox" value="Calefacci&oacute;n">
                        <label for="check-4">Calefacci&oacute;n</label>

                        <input name="checks[]" id="check-5" type="checkbox" value="laundry">
                        <label for="check-5">Lavadero</label>   

                        <input name="checks[]" id="check-6" type="checkbox" value="Gimnasio">
                        <label for="check-6">Gimnasio</label>

                        <input name="checks[]" id="check-7" type="checkbox" value="Alarma">
                        <label for="check-7">Alarma</label>

                        <input name="checks[]" id="check-8" type="checkbox" value="Persianas">
                ...
                <div class="submit-section">
                    ...
                    <div class="row with-forms">
                        ...
                        <div class="col-md-4">
                            <h5>Nombre</h5>
                            <input name="NombreContacto" type="text">
                        </div>

                        <!-- Email -->
                        <div class="col-md-4">
                            <h5>E-Mail</h5>
                            <input name="EmailContacto" type="text">
                        </div>

                        <!-- Name -->
                        <div class="col-md-4">
                            <h5>Tel&eacute;fono <span>(opcional)</span></h5>
                            <input name="TelefonoContacto" type="text">
                        </div>
                ...
                <!-- Section / End -->
                    ...
                    <button type="button" 
                            class="button preview margin-top-5"
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC8tu5xs6pNQGKR2-YhR4qJ_SeDn69Wb2Y&libraries=places&callback=initMap" async defer></script>
</body>
</html>