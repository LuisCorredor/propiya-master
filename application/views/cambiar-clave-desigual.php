			...
			<div class="row">
				<div class="col-md-6  my-profile">
					<form method="post" action="<?= site_url() ?>/seguridad/clave">
		    			...
		    			<!-- Success Message -->
		    			<div class="status error-box"><i class="fa fa-times"></i> Recuerde que las contraseñas ingresadas deben coincidir entre sí y tener un mínimo de 6 caracteres.</div>
